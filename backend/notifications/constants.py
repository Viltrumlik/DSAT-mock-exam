...
EVENT_TELEGRAM_GROUP = "TELEGRAM_GROUP"
...
EVENT_CATEGORY = {
    ...
    # Joining, or being taken out of, the class Telegram group. Classroom rather than
    # System: to a student this is news about their class, not about the platform.
    EVENT_TELEGRAM_GROUP: CATEGORY_CLASSROOM,
