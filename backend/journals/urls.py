...
urlpatterns = [
    ...
    path(
        "<int:journal_pk>/lessons/<int:pk>/roadmap/",
        RoadmapDetailView.as_view(),
        name="lesson-roadmap",
    ),
    path(
        "<int:journal_pk>/lessons/<int:pk>/roadmap/sections/<int:section_id>/media/",
        RoadmapSectionMediaView.as_view(),
        name="lesson-roadmap-section-media",
    ),
