...
from .views import (
    ...
    AdminAssessmentSetCsvExportView,
...
urlpatterns = [
    ...
    path("admin/sets/import-csv/", AdminAssessmentSetCsvImportView.as_view(), name="assessment-admin-sets-import-csv"),
    ...
    path("admin/sets/<int:pk>/status/", AdminAssessmentSetStatusView.as_view(), name="assessment-admin-set-status"),
    path("admin/sets/<int:set_pk>/questions/", AdminAssessmentQuestionCreateView.as_view(), name="assessment-admin-question-create"),
    path("admin/sets/<int:set_pk>/questions/import-csv/", AdminAssessmentSetQuestionsCsvImportView.as_view(), name="assessment-admin-questions-import-csv"),
    path("admin/sets/<int:set_pk>/questions/export-csv/", AdminAssessmentSetCsvExportView.as_view(), name="assessment-admin-questions-export-csv"),
